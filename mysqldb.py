...
connection = pymysql.connect(host='127.0.0.1',user='root',password='1234',db='testdb',charset='utf8mb4',cursorclass=pymysql.cursors.DictCursor)
...
try:
    ...
    print("Общее ремя в секундах:  ",time7/N)
